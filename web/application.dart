...
class Application {
  ...
  void Run() async {
    //TODO Callbacks should determine the needs
    _inputManager.Initialize(
        hasKeyInput: true, hasMouseInput: true, hasOneTouchInput: true);

    _framer
      ..Initialize()
      ..onUpdate30 = _OnUpdate30;
  ...
  void _InitializeSubscriptions() {
    _subscriptions
      ...
      ..add(_inputManager.onKeyDown.listen(_OnKeyDown))
      ..add(_inputManager.onKeyUp.listen(_OnKeyUp))
      ..add(_inputManager.onMouseDown.listen(_OnMouseDown))
      ..add(_inputManager.onMouseUp.listen(_OnMouseUp))
      ..add(_inputManager.onMouseMove.listen(_OnMouseMove))
      ..add(_inputManager.onMouseWheel.listen(_OnMouseWheel))
      ..add(_inputManager.onOneTouchDown.listen(_OneTouchDown))
      ..add(_inputManager.onOneTouchUp.listen(_OneTouchUp))
      ..add(_inputManager.onOneTouchMove.listen(_OneTouchMove));
  }
